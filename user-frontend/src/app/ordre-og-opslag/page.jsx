  ...
  return (
    <>
      {orders.map((order) => (
        <div
          key={order.id}
          className="bg-white w-11/12 mx-auto rounded-lg flex flex-col gap-4 p-4 overflow-hidden relative"
        >
          <svg
            className="absolute right-[-10px] top-0 h-48 w-[130px] object-cover pointer-events-none z-0"
            width="103"
            height="144"
            viewBox="0 0 103 144"
            fill="none"
          ...
          <div className="flex gap-2 z-10">
            <p className="text-white bg-darkgreen rounded-full px-2 text-xs">
              {order.price}kr./d.
            </p>
          ...
          <div className="flex gap-4">
            <div className="flex flex-col items-center">
              <div className="w-10 h-10 rounded-full flex justify-center items-center text-darkgreen bg-[#E2F0E9]">
            ...
            <div className="flex flex-col justify-between">
              <div className="">
                <p className="text-black font-medium text-sm">{order.pickup}</p>
                <p className=" text-gray-400 text-xs">Afhentningssted</p>
              </div>
              <div className="">
                <p className="text-black font-medium text-sm">{order.destination}</p>
                <p className=" text-gray-400 text-xs">Destination</p>
              </div>
            </div>
          </div>
          <div className="absolute right-[15px] h-[150px] top-8 z-10 w-[75px] flex-shrink-0">
            <img
              src={order.image}
              alt={order.title}

  ...
  return (
    <div className="flex flex-col gap-4">
      {products.map((product) => (
        <Link href={`/ordre-og-opslag/produkt/${product.product_id}`} key={product.product_id}>
        <div
        ...
        >
          ...
          <div className="absolute right-6 top-4 w-20 h-20">
            <Image
          ...
          <div className="w-11/12 mx-auto flex flex-col gap-4">
            <h3 className="text-xl pt-2 text-text font-bold">{product.name}</h3>

...
import { FaHouse, FaBookmark, FaUserLarge, FaPlus } from "react-icons/fa6"; // FaTimes for 'x'
...
export default function Navigation() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`bg-white w-full max-w-lg h-[700px] rounded-t-lg p-6 shadow-lg transform transition-transform duration-300 ${
        ...
        >
          <div className="flex justify-center items-center flex-col">
            ...
            <p className="text-xl text-center text-[#060606] mb-6">
              Opret opslag eller produkt
            </p>
            <div className="flex space-x-4 font-bold">
              <button className="px-4 py-2 bg-[#2B8F60] text-white text-semibold rounded-lg shadow-md">
                Opret produkt
              </button>
